...
```text
.
├── ARISE_Source_Code/                 # Full pipeline, experiment, and evaluation source code and scripts. 
├── agent_prompt                        # All prompt definitions used by ARISE agents
...
├── ARISE_sample_surveys_ouput_gpt4.1/ # Sample surveys and outputs generated by GPT-4.1 (main model)
...
### 📑 Folder Details
**gpt4.1 sample paper/**
All sample surveys and outputs were generated using GPT-4.1 as the writing model. For each survey topic (e.g., "Disease detection across modalities"), you will find:
...
final_paper_round{n}.pdf: Compiled survey PDF for each refinement round (e.g., round0 is initial, roundN is final).
...
All surveys and outputs were generated by running the full system pipeline using GPT-4.1 mini as the agent. Useful for demonstrating robustness to smaller models.
...
See the individual scripts in ARISE_Source_Code/ for details and configuration options.
### Notes
